...
<div class="container-fluid">
    ...
    <body>
        ...
        <h3 class="h1 text-danger">Chart Data Pendonor</h3>
        <div class="dropdown">
            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false">
                Tahun
            </button>
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="<?= base_url('/pimpinan/filter/') . date('Y'); ?>"><?= date('Y'); ?></a>
                <a class="dropdown-item" href="<?= base_url('/pimpinan/filter/2021'); ?>">2021</a>
                <a class="dropdown-item" href="<?= base_url('/pimpinan/filter/2022'); ?>">2020</a>
            </div>
        ...
        <script type="text/javascript">
            window.onload = function() {
                ...
                var chart = new CanvasJS.Chart("keluar1", {
                    ...
                    animationEnabled: true, // change to true		
                    title: {
                        text: "Chart Darah Keluar Tahun <?= date('Y'); ?>"
                    },
                    data: [{
                        // Change type to "bar", "area", "spline", "pie",etc.
                        type: "column",
                ...
                var chart = new CanvasJS.Chart("keluar2", {
                    ...
                    animationEnabled: true, // change to true		
                    title: {
                        text: "Chart Darah Keluar Bulan <?= date('M'); ?>"
                    },
                    data: [{
                        // Change type to "bar", "area", "spline", "pie",etc.
                        type: "column",
